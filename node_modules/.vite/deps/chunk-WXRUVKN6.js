...
var _createEmptyItemValue = Symbol("itemModel");
...
var ArrayModel = class extends AbstractModel {
   ...
   */
  *[(_a3 = _createEmptyItemValue, Symbol.iterator)]() {
    const array = this.valueOf();
    if (array.length !== __privateGet(this, _items).length) {
      __privateGet(this, _items).length = array.length;
    }
    for (let i = 0; i < array.length; i++) {
      let item = __privateGet(this, _items)[i];
      if (!item) {
        item = __privateGet(this, _createItem).call(this, this, i);
        __privateGet(this, _items)[i] = item;
      }
...
//# sourceMappingURL=chunk-WXRUVKN6.js.map
